        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-header">
                    <h5>{{ request()->resource == 'products' ? 'Medicines ' : (request()->resource == 'purchases' ? 'Purchases' : (request()->resource == 'sales' ? 'Sales' : '')) }}
                        Reports</h5>
                ...
                <div class="card-body">
                    @isset($sales)
                        ...
                        <hr>
                        <a href="{{ route('export.sales') }}" class="btn btn-success mb-3">Export Sales</a>
                    @endisset
