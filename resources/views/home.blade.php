                    ...
                    <div class="row-table">
                        <div class="col-sm-6 card-body br">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                    <h5>{{ AppSettings::get('app_currency', '$') }} {{ $formatted_today_sales }}</h5>
                        ...
                        <div class="col-sm-6 card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                    <h5>{{ AppSettings::get('app_currency', '$') }} {{ $formatted_yesterday_sales }}</h5>
                    ...
                    <div class="row-table">
                        <div class="col-sm-6 card-body br">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                    <h5>{{ AppSettings::get('app_currency', '$') }} {{ $formatted_last_sevenDays }}</h5>
                        ...
                        <div class="col-sm-6 card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                    <h5>{{ AppSettings::get('app_currency', '$') }} {{ $formatted_total_sales }}</h5>
                                    <span>Revenue</span>
                                </div>
                            </div>
                        </div>
